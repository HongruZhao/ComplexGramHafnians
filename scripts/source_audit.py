...
def audit(root):
    ...
    inherited = json.loads((root / 'docs/INHERITED_SOURCES.json').read_text())['sha256']
    ...
    result = {'audit_type': 'source-only', 'lean_executed_by_this_script': False,
              ...
              'scope': 'Checks every shipped Lean source including Challenge and Verification; excludes dependency/build caches.'}
